...
ggplot()+
  geom_sf(data = acsTractsPHL.2019.sf, aes(fill = total_asian.2019),
          color = "transparent")+
  scale_fill_viridis_c("Asian Population", option = "B", begin = 0.4)+
  ...
  labs(
    title = "Amount of Asian in Philadelphia by Tract",
    subtitle = "",
