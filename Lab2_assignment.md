...
``` r
acs_vars <- c("B01001B_002", #Estimate of Total Man
              "B01001D_001") #Estimate of Total Asian

myTracts <- c("42101036900", "42101008801", "42101008802")

acsTractsPHL.2019.sf <- get_acs(geography = "tract",
                             year = 2019,
                             variables = paste0(acs_vars,"E"),
                             geometry = TRUE,
                             state  = "PA",
                             county = "Philadelphia",
                             output = "wide") %>%
  dplyr::select (GEOID, NAME, all_of(paste0(acs_vars,"E"))) %>%
  rename (total_male.2019 = B01001B_002E, total_asian.2019 = B01001D_001E) %>%
